...
export default function SignIn(){
    ...
    const handleChange = (e) => {
        ...
        setUserData(prev => {
            ...
            checkData(newUserData);
            if (!value) {  // Check if the field is cleared
                setErrorMessage(""); // Clear the error message when input is cleared
            }
            return newUserData;
        });
    }
    const handleSubmit = (e) => {
        ...
        const submitData = async () => {
            ...
            if(response.status == 401){
                setErrorMessage("You have entered wrong Email / Password"); 
                return;
            }
